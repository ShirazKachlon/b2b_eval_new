...
def correct_2d_by_3d(df, im_width=3840.0, im_height=1920.0):
    """
    The following function corrects MF bounding box on image plane according to their 3D box in world plane
    :param df:
    :param im_width:
    :param im_height:
    :return:
